...
public class TreeSmall extends StaticEntity{
	...
	public TreeSmall(Handler handler, float x, float y) {
	...
	public void die() {
		...
		if ( live > 0 ) {
			handler.getLevel01().getItemManager().addItem(Item.wood2Item.createNew((int) x + Tile.TILEWIDTH, (int) y - Tile.TILEHEIGHT));
		}	
	}
